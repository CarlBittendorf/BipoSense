function (;
        ...
        var"data#BipoSense Latent Variables",
    ...
    @chain begin
        ...
        leftjoin(var"data#BipoSense Latent Variables"; on = [:Participant, :Date])
        ...
        select(:Participant, :Date, :State, VARIABLES...)
        ...
        transform(
            [:LatentCommunicationLNVAR, :LatentActiveLNVAR, :LatentSleepLNVAR] .=>
                (x -> 10 * x);
            renamecols = false
        )
    end
